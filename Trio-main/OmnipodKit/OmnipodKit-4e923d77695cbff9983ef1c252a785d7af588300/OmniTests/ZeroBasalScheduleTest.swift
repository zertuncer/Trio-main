...
class ZeroBasalScheduleTests: XCTestCase {
    ...
    func testZeroOneZeroSegment() {
        ...
        let cmd2 = BasalScheduleExtraCommand(schedule: schedule, scheduleOffset: offset, acknowledgementBeep: false, completionBeep: true, programReminderInterval: 0, podType: dashType)
