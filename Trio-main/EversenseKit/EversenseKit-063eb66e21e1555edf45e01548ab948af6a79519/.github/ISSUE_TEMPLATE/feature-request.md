...
*Provide a clear and concise description of the problem. Explain how this issue affects your experience with the Eversense CGM and any specific scenarios where it occurs.*

## Describe the solution you'd like
*Detail the desired change or feature you'd like to see implemented in the EversenseKit driver. Be specific about how this solution would improve your experience and address the problem described above.*
...
## User Impact
*(Optional) Describe the impact of this issue on your use of the EversenseKit driver with the OSAID app. Include any specific examples or data that demonstrate how widespread or severe the problem is.*